...
- Regression equation is $\hat {y} = b_0 + b_1 * points$ is a a 
...
- Predicted salary(in millions) for a player that scores:
  1. 0 points: 1.509077
  2. 100 points: 2.364833
  3. 500 points: 5.78786
  4. 1000 points: 10.06664
  5. 2000 points: 18.62421
...
```{r}
plot(nsalary~nexperience,pch = 19, col = "chocolate1", main = "Scatterplot with lowess smooth"); lines(lowess(nexperience,nsalary))
...
- Provide concise descriptions for the plots of this section.
    This section gives us the relation between players' salary, players' positions and their experience.
