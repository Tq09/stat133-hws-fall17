...
# 0 blue proportion
count0 <- counter[1] / repetition
# 1 blue proportion
count1 <- counter[2] / repetition
# 2 blue proportion
count2 <- counter[3] / repetition
# 3 blue proportion
count3 <- counter[4] / repetition
# 4 blue proportion
count4 <- counter[5] / repetition
```
...
```{r}
a0 <- num == "0"
relFreq0 <- cumsum(a0)/ 1 : 1000
a1 <- num == "1"
relFreq1 <- cumsum(a1)/ 1 : 1000
a2 <- num == "2"
relFreq2 <- cumsum(a2)/ 1 : 1000
a3 <- num == "3"
relFreq3 <- cumsum(a3)/ 1 : 1000
a4 <- num == "4"
relFreq4 <- cumsum(a4)/ 1 : 1000
relFreq <- c(relFreq0, relFreq1, relFreq2, relFreq3, relFreq4)
reps <- c(rep(1:1000, 5))
times <- rep(0:4, each = 1000)
